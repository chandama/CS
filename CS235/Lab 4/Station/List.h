...
So the stack has a linked list. (private datamember is a linked list) but has 
its own functions that aren't the functions inside of linked list

We dont want people to have access to have all of these functions. We only want
them to be able to push and pop.
*/
#pragma once
